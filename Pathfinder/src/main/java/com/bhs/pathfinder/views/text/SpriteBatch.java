...
public class SpriteBatch {
	...
	//--Constants--//
	final static int VERTEX_SIZE = 6;                  // Vertex Size (in Components) ie. (X,Y,Z,U,V,M), M is MVP matrix index
	...
	// R: [none]
	public void drawSprite(float x, float y, float width, float height, TextureRegion region, float[] modelMatrix, float z)  {
